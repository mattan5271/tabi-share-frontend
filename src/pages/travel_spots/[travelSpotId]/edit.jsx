...
const AdminTravelSpotEdit = () => {
  ...
  const { data: travelSpot, error: travelSpotError, isLoading: travelSpotIsLoading, isError: travelSpotIsError } = useGetRequest(`${BASE_URL}/${travelSpotId}`);
  ...
  const onSubmit = (inputData) => {
    handlePatchRequest({
      ...
      modelJa: "旅行先",
      modelEn: "travel_spot",
      redirectPath: `${BASE_URL}/${travelSpotId}`,
    });
    reset();
  };
